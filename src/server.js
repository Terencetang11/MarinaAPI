...
// Assignment:  HW #9 - Portfolio Project
// Program Details: 
//
//   REST API implementation for simulating a marina which contains three entities,
//   users, boats and loads (cargo).  Users are allowed to create accounts and authenticate in
//   via an implementation of Auth0.  Boat entities provide basic CRUD functionality, but is a 
//   protected resource that requires the presence of a valid JWT via bearer auth token to access.
//   Loads are an unprotected resource that may be created or deleted at any time.  
//
